...
python examples/api_request_parallel_processor.py \
  --requests_filepath examples/data/example_requests_to_chat_completion.jsonl \
  --save_filepath examples/data/example_requests_to_chat_completion.jsonl \
...
- requests_filepath : str
    ...
    - an example file is provided at examples/data/example_requests_to_chat_completion.jsonl
